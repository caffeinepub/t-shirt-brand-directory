...
export class Backend implements backendInterface {
    ...
    async addBrand(arg0: string, arg1: string, arg2: string): Promise<BrandId> {
        if (this.processError) {
            try {
                const result = await this.actor.addBrand(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getBrand(arg0: BrandId): Promise<Brand> {
        if (this.processError) {
            try {
